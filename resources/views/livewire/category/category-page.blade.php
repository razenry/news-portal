<main class="container mx-auto px-4 py-8">
    ...
    <section class="mt-3">
        <div class="flex items-center justify-between gap-4 mb-3">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Berita terkini, kategori {{ $title }}</h2>
    ...
    <section class="mt-12">
        <div class="flex items-center justify-between gap-4 mb-3">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Topik terkini, kategori {{ $title }}</h2>
