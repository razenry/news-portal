<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl">
        ...
        {{-- <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 text-center dark:text-gray-400">© 2022 <a href=""
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-500 dark:text-gray-400">Developed by <span class="font-semibold">Razenry</span></p>
            <p class="text-sm text-gray-500 dark:text-gray-400">A project under <span class="font-semibold">RetartedDevs Startup</span></p>
        </div>
    </div>
</footer>
