    ...
    <aside aria-label="Related articles"
        ...
        <div class="px-4 mx-auto max-w-screen-xl">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <!-- Article 1 -->
                <article
                    class="group p-6 bg-white rounded-lg shadow-sm dark:bg-gray-700 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                    <div class="flex items-center mb-3">
                        <span
                            class="inline-block px-3 py-1 text-xs font-medium text-white bg-blue-600 rounded-full">Office</span>
                        <span class="ml-2 text-xs text-gray-500 dark:text-gray-300">5 min read</span>
                    </div>
                    <h3
                        class="mb-2 text-lg font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        <a href="#">Our First Office</a>
                    </h3>
                    <p class="mb-4 text-sm text-gray-600 dark:text-gray-300">Over the past year, Volosoft has undergone
                ...
                <article
                    ...
                    <div class="flex items-center mb-3">
                        <span
                            class="inline-block px-3 py-1 text-xs font-medium text-white bg-purple-600 rounded-full">Design</span>
                ...
                <article
                    ...
                    <div class="flex items-center mb-3">
                        <span
                            class="inline-block px-3 py-1 text-xs font-medium text-white bg-green-600 rounded-full">Partnership</span>
                ...
                <article
                    ...
                    <div class="flex items-center mb-3">
                        <span
                            class="inline-block px-3 py-1 text-xs font-medium text-white bg-yellow-500 rounded-full">Development</span>
